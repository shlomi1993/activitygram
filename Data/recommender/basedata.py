...
class ProgramEntities:
    ...
    def __init__(self):
        ...
        for filename in ["./kaggle-dataset/train.csv", "./kaggle-dataset/test.csv"]:
            f = open(filename, 'rb')
        ...
        for i, e in enumerate(uniqueEvents):
            self.eventIndex[e] = i
        ftrain = open("./kaggle-dataset/train.csv", 'rb')
        ftrain.readline()
        for line in ftrain:
            cols = line.strip().split(b",")
...
class Users:
    ...
    def __init__(self, programEntities, sim=ssd.correlation):
        ...
        fin = open("./kaggle-dataset/users.csv", 'rb')
...
class UserFriends:
    ...
    def __init__(self, programEntities):
        ...
        fin = open("./kaggle-dataset/user_friends.csv", 'rb')
...
class Events:
    ...
    def __init__(self, programEntities, psim=ssd.correlation, csim=ssd.cosine):
        cleaner = DataCleaner()
        fin = open("./kaggle-dataset/events.csv", 'rb')
        fin.readline()  # skip header
...
class EventAttendees():
    ...
    def __init__(self, programEvents):
        ...
        f = open("./kaggle-dataset/event_attendees.csv", 'rb')
